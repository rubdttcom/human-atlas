...
4. **VHF cryosections with AI** (own project, `docs/plans/vhf-cryosection-machine-driven-plan.md`): appendicular bones, hands, trunk and head of the same donor at 0.33 mm. **Started 2026-09-13** with the inventory of the 5,186 colour slices already on rub-pc; training runs on the RTX 3080 as planned in plan B section 7; any download or import beyond plan B still needs a separate decision.
