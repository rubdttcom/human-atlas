...
4. **Procedure tests.** The controls must catch deliberate faults: swapped labels, a deleted body, a merged pair, a split body, a 15 mm shift, a missing chunk, a changed crop or chunk boundary (`ct-vertebra-instances.py --selftest`, `skellytour-seam-check.py`, the merge script's refusal of missing or ambiguous chunks). Passing them proves the checks work, not that the anatomy is right.
